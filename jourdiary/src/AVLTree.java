...
public class AVLTree<E extends Comparable<E>> extends BinarySearchTreeWithRotate<E> {
	...
	private AVLNode<E> rebalanceRight(AVLNode<E> localRoot) {
		...
		if (rightChild.balance < AVLNode.BALANCED) {
			...
			// After the rotates the overall height will be reduced thus increase is now false, but decrease is now true.
			increase = false;
			decrease = true;
      ...
      /* In this case both the rightChild (the new root)
         ...
         after the rotation. Also, the overall height will be
	...
	private AVLNode<E> rebalanceRightL(AVLNode<E> localRoot) {
      ...
      /* After the rotation of the rightChild (new root) will
